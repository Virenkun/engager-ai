    ...
    <Loader loading={loading}>
      <div className="flex flex-col gap-5">
        <div className="flex flex-col gap-3">
          <SubscriptionCard
            title="STANDARD"
            description="Perfect if you’re just getting started with Enagager AI"
            price="0"
            payment={payment}
        ...
        {payment === 'STANDARD' && (
          <Button onClick={onUpdatetToFreTier} className='bg-violet-700 text-white hover:bg-violet-800'>
